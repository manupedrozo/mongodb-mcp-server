...
export class ApiClient {
    ...
    // (undocumented)
    updateCluster(groupId: string, clusterName: string, body: Partial<components["schemas"]["ClusterDescription20240805"]>): Promise<components["schemas"]["ClusterDescription20240805"]>;
    // (undocumented)
